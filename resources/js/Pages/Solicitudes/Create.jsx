...
function Create({auth, can, actividades, periodos}) {
    ...
    >
      ...
      <div className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form onSubmit={submit}>
          ...
          <Link href={route('solicitud.show',auth.user.id)} className="mt-4 font-semibold text-xs text-white bg-red-600 hover:bg-red-700 rounded-md mr-2 mb-2 p-2 uppercase">
            Cancelar
          </Link>
          <PrimaryButton
