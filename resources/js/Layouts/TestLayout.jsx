...
export default function Authenticated({ auth, header, children }) {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-100">
            {/* Barra superior */}
            <nav className="min-w-full   bg-white border-b border-gray-100">
            ...
            <div className="flex flex-grow overflow-hidden">
                ...
                {/* Menu lateral*/}
                <div className="hidden sm:flex flex-col items-center w-40 flex-shrink-0 overflow-y-auto text-gray-700 bg-gray-100 rounded">
                ...
                <main scroll-region className='flex-1 px-4 py-8 md:p-12 md:overflow-y-auto bg-white'>
                    {header && (
                        <header>
                            <div className="mb-8 text-3xl font-bold">{header}</div>
                        </header>
                    )}
                    {children}
                </main>
