   ...
   return (
      <div className="hidden sm:flex flex-col items-center w-45 flex-shrink-0 overflow-y-auto text-gray-700 bg-gray-200">
         ...
         <div className="w-full px-2">
            <div className="flex flex-col items-center w-full mt-1 border-gray-300">
               <NavLink
               ...
               >
                  ...
                  <span className="ml-2 text-basefont-medium">
                     Inicio
                  </span>
               </NavLink>
               ...
               <NavLink
                  href={route("escolares.solicitudes")}
                  active={route().current("escolares.solicitudes")}
                  className={
                     hasRole.escolares
                        ? "flex"
                        : "hidden"
